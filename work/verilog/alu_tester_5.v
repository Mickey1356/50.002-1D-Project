...
module alu_tester_5 (
  ...
  reg [1-1:0] M_auto_tester_fail;
  auto_tester_7 auto_tester (
    .clk(clk),
    .rst(rst),
    .next(M_auto_tester_next),
    .fail(M_auto_tester_fail),
  ...
  reg [1-1:0] M_manual_tester_man_out;
  manual_tester_8 manual_tester (
    .clk(clk),
    .rst(rst),
    .switches(M_manual_tester_switches),
    .man_next(M_manual_tester_man_next),
    .man_out(M_manual_tester_man_out),
  ...
  always @* begin
    ...
    M_auto_tester_fail = switches[16+0-:1];
    M_auto_tester_next = auto_next;
    M_manual_tester_man_next = man_next;
    M_manual_tester_man_out = man_out;
